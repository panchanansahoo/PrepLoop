...
`).length," lines"]}),e.jsxs("span",{className:"pg-status-item",children:[a.length," chars"]})]}),e.jsxs("div",{className:"pg-status-right",children:[e.jsxs("span",{className:"pg-status-item",children:[k.icon," ",k.label]}),e.jsxs("span",{className:"pg-status-item",children:["Stage: ",Se]}),e.jsxs("span",{className:"pg-status-item",children:["Last: ",L?`${Math.round(L.totalMs)}ms`:"N/A"]}),e.jsxs("span",{className:"pg-status-item",children:["Font: ",ve,"px"]}),e.jsx("span",{className:"pg-status-item",children:"UTF-8"})]})]}),(N||f||ee||Ge)&&e.jsx("div",{className:"pg-overlay",onClick:()=>{g(!1),j(!1),B(!1),be(!1)}})]})}export{zr as default};
