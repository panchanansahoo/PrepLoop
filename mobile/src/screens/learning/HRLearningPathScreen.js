...
// Mock data for HR Learning
const MOCK_HR_PATH = [
    { id: "hr1", title: "Introduction to HR Interviews", description: "Understand the purpose and structure of behavioral interviews.", completed_topics: 2, total_topics: 2 },
    { id: "hr2", title: "The STAR Method", description: "Learn how to structure your answers using Situation, Task, Action, Result.", completed_topics: 1, total_topics: 3 },
    { id: "hr3", title: "Common HR Questions", description: "Tell me about yourself, strengths/weaknesses, and conflict resolution.", completed_topics: 0, total_topics: 6 },
    { id: "hr4", title: "Company Research & Culture Fit", description: "How to research a company and show alignment with their values.", completed_topics: 0, total_topics: 3 },
    { id: "hr5", title: "Salary Negotiation & Closing", description: "Professional etiquette, asking questions, and negotiating offers.", completed_topics: 0, total_topics: 4 },
];

export default function HRLearningPathScreen({ navigation }) {
    ...
    if (loading) {
        return (
            <View style={styles.container}>
                <ScreenHeader title="HR Interviews" onBack={() => navigation.goBack()} />
                <LoadingSpinner />
            </View>
        );
    }
    ...
    return (
        <View style={styles.container}>
            <ScreenHeader title="HR Learning Path" onBack={() => navigation.goBack()} />
            <ScrollView
            ...
            >
                <View style={styles.timeline}>
                    {MOCK_HR_PATH.map((module, index) => {
                        const isLast = index === MOCK_HR_PATH.length - 1;
