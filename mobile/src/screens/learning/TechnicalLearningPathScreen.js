...
// Mock data for Technical Learning
const MOCK_TECH_PATH = [
    { id: "tech1", title: "Operating Systems", description: "Processes, Threads, Memory Management, and Concurrency.", completed_topics: 5, total_topics: 5 },
    { id: "tech2", title: "Database Management Systems", description: "Normalization, Transactions, ACID properties, and Indexing.", completed_topics: 1, total_topics: 6 },
    { id: "tech3", title: "Computer Networks", description: "OSI Model, TCP/IP, Routing, and Application Protocols.", completed_topics: 0, total_topics: 4 },
    { id: "tech4", title: "Object Oriented Programming", description: "Inheritance, Polymorphism, Encapsulation, and Design Patterns.", completed_topics: 0, total_topics: 5 },
];

export default function TechnicalLearningPathScreen({ navigation }) {
    ...
    if (loading) {
        return (
            <View style={styles.container}>
                <ScreenHeader title="Technical CS" onBack={() => navigation.goBack()} />
                <LoadingSpinner />
            </View>
        );
    }
    ...
    return (
        <View style={styles.container}>
            <ScreenHeader title="Technical Learning Path" onBack={() => navigation.goBack()} />
            <ScrollView
            ...
            >
                <View style={styles.timeline}>
                    {MOCK_TECH_PATH.map((module, index) => {
                        const isLast = index === MOCK_TECH_PATH.length - 1;
