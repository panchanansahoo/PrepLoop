...
export default router;
  ...
  // ─── ADMIN BLOG POST MANAGEMENT (Admin Only) ───────────────────
  ...
  // GET /api/blog/admin/posts/:id - Get single admin blog post
  ...
  // POST /api/blog/admin/posts - Create new admin blog post
  ...
  // PUT /api/blog/admin/posts/:id - Update admin blog post
  ...
  // DELETE /api/blog/admin/posts/:id - Delete admin blog post
  ...
  // PATCH /api/blog/admin/posts/:id/publish - Publish a draft blog post
  ...
  // PATCH /api/blog/admin/posts/:id/archive - Archive blog post
  ...
  // GET /api/blog/public/posts/:slug - Get published blog post by slug (public)
