...
async function main() {
    ...
    const missingSolutions = problems.filter(p => {
        ...
        // Consider a problem "solved" if it has all 4 main languages
    ...
    for (const problem of missingSolutions.slice(0, 5)) {
        try {
...
For Python, write classical class Solution: def functionName(self, ...): ... or just def functionName(...) if it makes sense. 
